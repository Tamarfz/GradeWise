    ...
    useEffect(() => {
        ...
        const checkJudgeGraded = async () => {
            try {
                ...
                if (response.ok) {
                    const data = await response.json();
                    if (data && data.gradeInfo) {
                        // Check if the judge has actually graded (not null values)
                        const isGraded = data.gradeInfo.complexity !== null && 
                                       data.gradeInfo.usability !== null && 
                                       data.gradeInfo.innovation !== null && 
                                       data.gradeInfo.presentation !== null && 
                                       data.gradeInfo.proficiency !== null;
                        setJudgeGraded(isGraded);
                    } else {
                        setJudgeGraded(false);
                    }
                }
            } catch (error) {
