...
const SearchContainer = styled.div`
    ...
    @media (max-width: 768px) {
        z-index: auto; /* Allow the menu to render naturally on mobile */
    }
`;
...
// Custom styles for react-select - matching assign-projects design (desktop)
...
// Mobile-specific styles for react-select to keep the menu anchored and responsive
                ...
                {searchField && (
                    <SelectContainer>
                        <Select
                            ...
                            styles={isMobile ? mobileSelectStyles : customSelectStyles}
